...
from model.model_mortis import MortisConfig
...
def train_epoch(epoch, loader, iters, start_step=0, wandb=None):
    ...
    for step, (X, Y, loss_mask) in enumerate(loader, start=start_step + 1):
        ...
        if step % args.log_interval == 0 or step == iters - 1:
            ...
            if wandb: wandb.log({"loss": current_loss, "aux_loss": current_aux_loss, "learning_rate": current_lr, "epoch_time": eta_min})
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Mortis Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="Mortis-Full-SFT", help="wandb项目名")
    ...
    lm_config = MortisConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Mortis-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
